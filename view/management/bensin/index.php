...
?>
<?php startblock('title') ?> Bensin Management <?php endblock() ?>

<?php startblock('breadcrumb-link') ?>
<li class="breadcrumb-item"><a href="#!">Bensin Management</a>
<?php endblock() ?>
...
<div class="card">
  <div class="card-block">
      <div class="dt-responsive table-responsive">
          <table id="tblbensin" class="table table-striped table-bordered nowrap" style="width:100%">
              <thead>
                  <tr>
                ...
                ?>
                  <tr>
                      ...
                      <td style="width:100px">
                        ...
                        <?php } ?>
                        <?php if($hak_akses==1 || $hak_akses==2){ ?>
                        <a href="#" class="btn btn-danger btn-mini waves-effect waves-light" onclick="hapus('<?php echo $data['kode_bensin']; ?>')">Delete</a>
                        <?php } ?>
                      </td>
                  </tr>
                <?php } ?>
          ...
          <form class="" id="formdelete" style="display:none" action="/tb_pbd_sp/controller/bensinController.php?aksi=delete" method="post">
            <input type="text" name="kode_bensin" value="" id="delete_id">
          </form>
                </div>
            </div>
          </div>
  ...
  <script type="text/javascript">
      $('#tblbensin').DataTable(
        ...
        buttons: [
        {
            ...
            {
              window.location.assign("/tb_pbd_sp/view/management/bensin/create.php");
            }
        },
        {
            extend: 'copy',
