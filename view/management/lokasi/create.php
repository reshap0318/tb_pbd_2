...
<li class="breadcrumb-item"><a href="/tb_pbd_sp/view/management/lokasi">Lokasi</a>
...
<div class="card">
    <div class="card-block">
        <form id="second" action="/tb_pbd_sp/controller/lokasiController.php?aksi=create" method="post" novalidate>
